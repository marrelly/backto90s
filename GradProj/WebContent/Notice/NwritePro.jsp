...
<h1>공지사항 필독!!</h1>
<hr>
<form method="post" action="NSuccess.jsp"> 
...
<td><input type="text" name="password" id="passwd" required></td>
</tr>
<tr>
</table>
...
<input class="bdbtn" type="button" value="목록" onclick="location.href='NSuccess.jsp'">
</center>
